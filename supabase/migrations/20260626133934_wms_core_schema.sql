...
CREATE POLICY "shift_insert" ON shifts FOR INSERT TO authenticated WITH CHECK (true);
...
CREATE POLICY "shift_delete" ON shifts FOR DELETE TO authenticated USING (true);
...
CREATE POLICY "sched_insert" ON schedules FOR INSERT TO authenticated WITH CHECK (true);
DROP POLICY IF EXISTS "sched_update" ON schedules;
CREATE POLICY "sched_update" ON schedules FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
DROP POLICY IF EXISTS "sched_delete" ON schedules;
CREATE POLICY "sched_delete" ON schedules FOR DELETE TO authenticated USING (true);
...
CREATE POLICY "att_insert" ON attendance_records FOR INSERT TO authenticated WITH CHECK (true);
DROP POLICY IF EXISTS "att_update" ON attendance_records;
CREATE POLICY "att_update" ON attendance_records FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
DROP POLICY IF EXISTS "att_delete" ON attendance_records;
CREATE POLICY "att_delete" ON attendance_records FOR DELETE TO authenticated USING (true);
...
CREATE POLICY "lt_insert" ON leave_types FOR INSERT TO authenticated WITH CHECK (true);
DROP POLICY IF EXISTS "lt_update" ON leave_types;
CREATE POLICY "lt_update" ON leave_types FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "lb_insert" ON leave_balances FOR INSERT TO authenticated WITH CHECK (true);
DROP POLICY IF EXISTS "lb_update" ON leave_balances;
CREATE POLICY "lb_update" ON leave_balances FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "lr_insert" ON leave_requests FOR INSERT TO authenticated WITH CHECK (true);
DROP POLICY IF EXISTS "lr_update" ON leave_requests;
CREATE POLICY "lr_update" ON leave_requests FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
DROP POLICY IF EXISTS "lr_delete" ON leave_requests;
CREATE POLICY "lr_delete" ON leave_requests FOR DELETE TO authenticated USING (true);
...
CREATE POLICY "ann_update" ON announcements FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "pr_insert" ON performance_reviews FOR INSERT TO authenticated WITH CHECK (true);
DROP POLICY IF EXISTS "pr_update" ON performance_reviews;
CREATE POLICY "pr_update" ON performance_reviews FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
